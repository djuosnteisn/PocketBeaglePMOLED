...
make_test.exe: win.cpp win.h fonts.c fonts.h bmps.c bmps.h P25317.cpp P25317.h GPIO.cpp GPIO.h \
		...
		pages/page_shutdown.h pages/page_backlight.h pages/page_backlight.cpp \
		pages/page_about.cpp pages/page_about.h \
		pages/page_compat.h pages/page_compat.cpp
	arm-linux-gnueabihf-g++-6 main.cpp page.cpp btns.cpp win.cpp fonts.c bmps.c P25317.cpp \
		...
		pages/page_shutdown.cpp pages/page_backlight.cpp pages/page_about.cpp \
		pages/page_compat.cpp -lpthread -o make_test.exe
